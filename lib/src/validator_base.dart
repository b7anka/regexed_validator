...
final RegExp _nameRegex =
    RegExp(r"^([áàãâéèíìóòúùõôçÁÀÃÂÉÈÍÌÓÒÚÙÕÔÇA-Za-z][ÁÀÃÂÉÈÍÌÓÒÚÙÕÔÇáàãâéèíìóòúùõôça-z.'\-]+) (?:([áàãâéèíìóòúùõôçÁÀÃÂÉÈÍÌÓÒÚÙÕÔÇA-Za-z][áàãâéèíìóòúùõôçÁÀÃÂÉÈÍÌÓÒÚÙÕÔÇA-Za-z.'\-]+) )?([áàãâéèíìóòúùõôçÁÀÃÂÉÈÍÌÓÒÚÙÕÔÇA-Za-z][áàãâéèíìóòúùõôçÁÀÃÂÉÈÍÌÓÒÚÙÕÔÇA-Za-z.'\-]+)$");
final RegExp _postalCodeRegex = RegExp(r"^\d{4}(-\d{3})?$");
